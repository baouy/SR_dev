...
public class DateUtil {
    ...
    public static String DATETIMEN_PATTERN = "yyyy-MM-ddHH:mm:ss";
    public static String DATE_PATTERN = "yyyyMMddHHmmss";
    public static String DATE_PATTERN_HH = "MM月dd日HH:00";
    /**
     * 则个
     */
    ...
    /** 格式：2017-05-25 12:34:48 */
    public static String convertToDateHH(String str) {
        int lg = str==null?0: str.length();
        if(lg>=8 && lg<10 ) return str.substring(5).concat("日").replace("-","月");
        if (lg==10) return str.substring(5,10).concat("日").replace("-","月");
        if (lg >10) {

            String a = str.substring(14,16);

            return str.substring(5, 13).concat(":").replace("-", "月").replace(" ", "日")+a;
        }
        return "";
    }
    ...
    public static Boolean isTypeDate(String content){
    ...
    public static Date parseToDate(String checkValue){
        ...
        if(checkValue != null && !checkValue.equals("")){
            ...
            try {
                return dateFormat.parse(checkValue);
            } catch(Exception e) {
                return null;
            }
        }else {
     ...
     * @return
     */
    public static String getLastWeek0() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Calendar cal = Calendar.getInstance();
        int min = cal.getActualMinimum(Calendar.DAY_OF_WEEK) - 7; //获取周开始基准
        int current = cal.get(Calendar.DAY_OF_WEEK); //获取当天周内天数
        cal.add(Calendar.DAY_OF_WEEK, min - current); //当天-基准，获取周开始日期
        cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONDAY), cal.get(Calendar.DAY_OF_MONTH), 0, 0, 0);
        return sdf.format(cal.getTime());
     ...
     * @return
     */
    public static String getLastWeek1() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Calendar cal = Calendar.getInstance();
        int min = cal.getActualMinimum(Calendar.DAY_OF_WEEK) - 7; //获取周开始基准
        int current = cal.get(Calendar.DAY_OF_WEEK); //获取当天周内天数
     ...
     * @return
     */
    public static String getLastMounth0String() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Calendar cal = Calendar.getInstance();
    ...
    /**
     * 获取上个月最后一天23时59分59秒时间字符串
     *
     * @return
     */
    public static String getLastMounth1String() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Calendar cal = Calendar.getInstance();
        cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONDAY)-1, cal.get(Calendar.DAY_OF_MONTH), 23, 59, 59);
        cal.set(Calendar.DAY_OF_MONTH, cal.getActualMaximum(Calendar.DAY_OF_MONTH));
        cal.set(Calendar.HOUR_OF_DAY, 23);
        return sdf.format(cal.getTime());
    }
	...
	{
    	String timeDir= DateUtil.getCurrentDateString();
		System.out.println(timeDir);
        //System.out.println("result:"+ DateUtil.parseToDate("2017/6/810:18:12"));
    }
